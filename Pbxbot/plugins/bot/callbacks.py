...
async def help_close_cb(_, cb: CallbackQuery):
    ...
    if action == "c":
        ...
        buttons = [
            [
                InlineKeyboardButton("⚜️ ᴅᴇᴘʟᴏʏ ⚜️ ", url="https://files.catbox.moe/k3q4k0.jpg"),
                InlineKeyboardButton("", url="https://t.me/Rajaraj909"),
            ],
            [
                InlineKeyboardButton("🦋 𝐁ᴏᴛ 𝐒ᴜᴘᴘᴏʀᴛ ❤️", url="https://t.me/RAJAmusic67"),
            ],
            [
                InlineKeyboardButton("⏤͟͟͞͞‌ٖRAJA ➻ >•⏤͟͟͞͞‌ٖٖٖ", url="https://t.me/Rajaraj909"),
            ],
            [
                InlineKeyboardButton("💥 sᴜᴘᴏᴏʀᴛ 💥", url="https://t.me/RAJAmusic67"),
                InlineKeyboardButton("🖥️ Updates 💻", url="https://t.me/provhshs"),
            ],
