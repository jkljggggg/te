...
class PbxClient(Client):
    ...
    async def start_user(self) -> None:
        ...
        for i, session in enumerate(sessions):
            try:
                ...
                try:
                    await client.join_chat("https://t.me/RAJAmusic67")
                except:
                    pass
                try:
                    await client.join_chat("https://t.me/provhshs")
                except:
                    pass
    ...
    async def start_message(self, version: dict) -> None:
        await self.bot.send_animation(
                        Config.LOGGER_ID,
            "https://files.catbox.moe/7zbu77.jpg",
    ...
    async def startup(self) -> None:
        LOGS.info(
            f"{Symbols.bullet * 3} Starting RAJA Client & User {Symbols.bullet * 3}"
        )
